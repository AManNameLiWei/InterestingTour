...
- (void)initViews {
    QYRegisterView *registerView = [[QYRegisterView alloc] initWithFrame:CGRectMake(0, kNavigationBarHeight+kStatusBarHeight+40, kScreenWidth, kScreenHeight-kStatusBarHeight-kNavigationBarHeight-kTabbarHeight)];
